...
//               and tests escape against |Z|^2 > 4. State is registered and
//               propagated to the next pipeline stage. Once a pixel escapes,
//               the escape flag becomes sticky and the iteration index at
//               escape is latched.
// ============================================================================
