...
module Mandelbrot_Engine #(
    ...
    input                       i_Pan_Dir,          // Switch for pan direction (UD/LR)
    input                       i_Pan_UL,           // Button for Pan Up/Left
    input                       i_Pan_DR,           // Button for Pan Down/Right
    input                       i_Zoom_In,          // Button for Zoom In
    input                       i_Zoom_Out,         // Button for Zoom Out
